...
# Upskilling won't save us from AI
...
Here are some more examples I have heard from smart people:
- "Moving into product management is a safe bet for engineers. Managing agents is what they're pivoting towards anyway."
- "Moving into sales is a safe bet because people want to buy from other people"
...
Maybe everyone else is as pessimistic as I am but just not admitting it. For a worker to face that there is no way to change in order to be able to continue to provide for themselves and their families is very scary. It's hard to talk about honestly because we still need to get through the day without cracking. But we should talk about it. Let's take the above examples steps one step further:

|Coping thought| One step further |
|--|--|
...
| I'll work for the government | Government work probably won't be as stable as it is now if a portion of the population no longer pays taxes |
...
The [Bureau of Labor Statistics](https://www.bls.gov/cps/cpsaat11.htm) said there were ~71 million workers in "Management, professional, and related occupations" (this category includes jobs I'd categorize as "AI-proof" but I'm leaving out 30 million "Sales and office occupations" so I think, without diving into the numbers, it's a fine conservative estimate).

Let's say eventually we reach a point where 25% of white collar workers have lost their jobs to AI. That is 17.75 million people. Out of a [170 million labor force](https://www.bls.gov/news.release/empsit.t01.htm), that would increase the unemployment rate by 10.4%. Adding it to today's 4.3% gives us 14.7% total. (It was 10% in October 2009 and briefly peaked at 14.8% during COVID) 
...
There will be third, fourth, etc. order effects from this that I'm not thinking of and maybe won't be possible to guess. I'm pretty pessimistic about how "AI taking our jobs" will pan out.

I think it's unrealistic that the government will get UBI together in time to avoid chaos. I think LLM companies deciding to share their revenue with everyone is a good joke. I think the only hope is for adoption by companies and AI improvement to be slower than expected. But I know the board members at my company are clamoring for employees to be replaced by AI*. And I'm sure yours are, too.
